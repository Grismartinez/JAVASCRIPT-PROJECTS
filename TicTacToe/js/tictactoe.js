...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x2 = coordX2,
        y2 = coordY2,
        //This variable stores temporary x and y axis data we update in our animation loop.
        x = x1,
        y = y1; 
    ...
    function animateLineDrawing() {
        ...
        //This condition is similar to the one above. It is for the 6,4,2 diagonal win condition.
        if (x1 <= x2 && y1 >= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y -= 10; }
            if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
